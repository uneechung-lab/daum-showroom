// 1. 로그인 상태 보안 체크 (오직 어드민 경로인 경우에만 미인증 사용자 차단 및 로그인 페이지로 리다이렉트)
const currentPath = window.location.pathname;
if ((currentPath === '/admin' || currentPath.startsWith('/admin/')) && !currentPath.includes('login.html') && sessionStorage.getItem('isAdminLoggedIn') !== 'true') {
