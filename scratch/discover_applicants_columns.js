...
async function discover() {
    const candidates = [
        'id', 'created_at', 'name', 'email', 'phone', 'contact',
        'job_title', 'role', 'title', 'exp_type', 'experience', 'career',
        'career_type', 'rank', 'rating', 'portfolio_url', 'portfolio',
        'message', 'cover_letter', 'intro', 'file_name', 'resume',
        'file', 'status', 'progress', 'state', 'attachment', 'attachment_name',
        'url', 'content'
    ];
    
    console.log("Starting column discovery for 'applicants'...");
